...
megabytes of memory representing TLS connections, with \SI{0.59}{\percent} of
this being IVs. In a server setup with four gigabytes of DRAM, the IVs would
only make \SI{74.5e-6}{\percent}. Even if an attacker could gain knowledge
