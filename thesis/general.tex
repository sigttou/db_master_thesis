...
framework, the source of the to be analysed program is not needed, and
recompilation of the program is not required if the instrumentation tool
changes. The framework allows to log and modify the runtime of a program,
...
Project Zero\cite{projectzerorow} the \texttt{mfence} is not required and even
