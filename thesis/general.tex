...
which can be used to test binaries on their own without knowing the whole source
code.
...
One of the most used symbolic analysis frameworks is angr~\cite{angrpaper}.
