...
executable files before introducing bitflips to them.
...
loaded into the program\textquotesingle s memory image are initialized data
...
possible violations of the program\textquotesingle s specification. The solver
can also be used to find possible paths to reach a pre-defined goal inside the
binary.
...
file\textquotesingle s owner. Tools like \texttt{su} and \texttt{sudo} need
this as they require the permission to change the current context. It is also
