...
Tells the CPU what to do and how to handle the following
parameters.

\subsubsection{ModR/M}

This byte follows the opcode to tell the CPU what
addressing mode to use for memory accesses.

\subsubsection{SIB}

This byte also needs to be parsed and evaluated for some ModR/M
addressing-modes.

\subsubsection{Displacement}

Displacement - Some addressing-modes set by the ModR/M or SIB byte
might include a displacement following them.

\subsubsection{Immediate}

Immediate - Immediate data might follow if required by previous
parameters.
