...
about the binary to test. It is a technique to detect erroneous responses of a
program by providing different inputs. Tools applying this technique are called
fuzzers. Fuzzers try to reach corner cases in programs without knowing exactly
which exist and detect undefined behaviour or crashes of software.

\todo{link deeper fuzzying technologies}
