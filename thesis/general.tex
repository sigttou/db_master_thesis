...
instead of using a \texttt{clflush} approach.  Also,
Qiao~\etal~\cite{newrowhammer} show how it is possible to trigger Rowhammer by
using malicious inputs on programs instead of running malicious code. The input
on running programs causes calls to \texttt{memset} or \texttt{memcpy} which can
be abused to trigger Rowhammer.
