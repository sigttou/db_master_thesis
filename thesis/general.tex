...
\todo{reference AES-GCM NIST standard}
...
Hanno Böck~\etal~\cite{gcmnonceattack} describe how relevant nonce reuse still is
in real-world application and why clear definitions for nonces in protocols are
needed.
