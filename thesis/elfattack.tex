...
\section{Finding Rowhammer-flaws in real-world Applications}
...
achieve this. Also, we also want to show how we can search for bitflips in other
applications. This subsection will present all our applications tested, if there
were adaptions made for instrumenting or testing, and the results for the
bitflips are presented.
...
\subsection{\texttt{sudo} - Privilege Escalation}
...
\subsection{\texttt{nginx} - HTTP Basic Authentication Bypass}
