...
%% general metadata:
\newcommand{\myauthor}{Daniel Kales}  %% also used for PDF metadata (hyperref)
\newcommand{\myauthorwithexistingtitles}{\myauthor{}, BSc}  %% including
                                %% university degree already held
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{Cryptanalysis of Tweakable Block Ciphers}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubtitle}{Application to MANTIS and QARMA}
\newcommand{\mysubject}{Cryptanalysis of Tweakable Block Ciphers}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{Tweakable Block Ciphers, differential cryptanalysis, mantis, qarma}  %% also used for PDF metadata (hyperref)
...
\newcommand{\mysupervisor}{Dipl.-Ing. Maria Eichlseder} %% your supervisor
%\newcommand{\mycosupervisor}{Dr.~Some Body} %% your supervisor
\newcommand{\myevaluator}{Univ.-Prof. Dipl.-Ing. Dr.techn. Christian Rechberger} %% your evaluator
