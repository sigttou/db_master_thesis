...
\newcommand{\myauthorwithexistingtitles}{\myauthor{}, BSc}  %% including
                                ...
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{All The Small Flips}
\newcommand{\mysubtitle}{Finding Rowhammer Targets in the Wild}
\newcommand{\mysubject}{Subject TBD}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{Rowhammer, Microarchitectural Attack, Automation}
...
\newcommand{\mysupervisor}{Daniel Gruss} %% your supervisor
%\newcommand{\mycosupervisor}{Dr.~Some Body} %% your supervisor
\newcommand{\myevaluator}{Stefan Mangard} %% your evaluator
...
\newcommand{\myid}{11330462} %% Matrikelnummer
...
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, arrows, trees, matrix}
\usepackage{multirow}
\usepackage{booktabs}
